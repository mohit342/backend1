...
const { generateCoupon, getSchoolCoupons,sendCouponEmail, validateCoupon ,generateStudentCoupon,sendStudentCouponEmail} = require('../controllers/couponController');
